...
const EditBlog = () => {
  ...
  const editBlog = async (e)=>{
    e.preventDefault()
    const response = await axios.put("https://64ee096e1f872182714237b9.mockapi.io/blog/" + id,blog)
    ...
    <div className="container">
        <Navbar />
          ...
          <form onSubmit={editBlog} >
              ...
              <textarea id="content" placeholder='content' onChange={(e)=>setBlog({...blog,content:e.target.value})} value={blog.content} name="content" rows="10" required  ></textarea>
